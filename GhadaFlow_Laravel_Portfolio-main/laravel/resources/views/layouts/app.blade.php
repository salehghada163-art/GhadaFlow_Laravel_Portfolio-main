...
<head>
    ...
    <meta
        name="description"
        content="@yield('description', 'GhadaFlow — Ghada Saleh Al-Towijri, Web Developer.')"
    >

    <title>
        @yield('title', 'GhadaFlow | Web Developer')
    </title>
        ...
        >
            ...
            <div class="nav-links">
                ...
                >
                    ...
                    class="nav-link @yield('nav_certificates', '')"
                    data-nav-link
                    href="{{ route('certificates') }}"
                    data-i18n="nav.certificates"
                >
                    Certificates
                </a>
...
<footer class="site-footer">
    ...
    <div class="container footer-content">
        ...
        <div class="footer-brand">
            ...
            <p data-i18n="footer.name">
                Ghada Saleh Al-Towijri
            </p>

            <span data-i18n="footer.title">
                Web Developer
            </span>
    ...
    <div class="footer-bottom">
        ...
        <div class="container">
            ...
            <span data-i18n="footer.copyright">
                © 2026 GhadaFlow. All rights reserved.
            </span>
