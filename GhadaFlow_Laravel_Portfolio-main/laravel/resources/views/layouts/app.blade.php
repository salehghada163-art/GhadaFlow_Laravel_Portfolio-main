...
<a class="nav-link @yield('nav_contact', '')" data-nav-link href="{{ route('contact.show') }}" data-i18n="nav.contact">Contact</a>
</div>
...
<a href="mailto:ghadacareer75@outlook.com" data-i18n="nav.email">Email</a>
...
<a href="{{ route('contact.show') }}" data-i18n="nav.contact">Contact</a>
</div>
</div>
